...
class TgUser(models.Model):
    ...
    tg_username = models.CharField(max_length=30, validators=[MinLengthValidator(8)], blank=True, null=True,
                                   verbose_name="Пользователь")
    user = models.ForeignKey('core.User', verbose_name="Пользователь приложения", blank=True, null=True,
